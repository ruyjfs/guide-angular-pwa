...
# 1. Docker
## 1.1 Start container docker to setting up environment
    docker run -it -v /var/www:/var/www -p 4200:4200 --name node-front ryubr/node-alpine
    
Read the docker image description to learn more about this image [ryubr/node-alpine](https://hub.docker.com/r/ryubr/node-alpine)
## 1.2 Enter the shared folder between the container and your machine 
    cd /var/www    
# 2. Angular-CLI
## 2.1 Create Angular project with Angular-CLI and enter in path
    ng new guide-angular-pwa /
    cd guide-angular-pwa
Learn more about [Angular-CLI](https://cli.angular.io/)
## 2.2 Include a template framework Angular Material 2 and all depedencies
    npm install --save @angular/material@2.0.0-beta.2
Learn more about [Material Angular](https://material.angular.io/)
...
## 2.4 Add Material icons and a theme to styles.css (This file is a style global of app)
...
## 2.5 Edit and replace the contents of the file src/app/app.component.html (This file is like an app template)
...
Note: --host 0.0.0.0 why it is running inside the container
